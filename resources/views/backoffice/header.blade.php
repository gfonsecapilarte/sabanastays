    ...
    <div class="navbar-header">
        ...
        <div class="top-left-part">
            <a class="logo" href="index.html">
                <b>
                <!--This is dark logo icon--><img src="{{ asset('images/backoffice/pixeladmin-logo.png') }}" alt="home" class="dark-logo" /><!--This is light logo icon--><img src="{{ asset('images/backoffice/pixeladmin-logo-dark.png') }}" alt="home" class="light-logo" />
             </b>
                <span class="hidden-xs">
                <!--This is dark logo text--><img src="{{ asset('images/backoffice/pixeladmin-text.png') }}" alt="home" class="dark-logo" /><!--This is light logo text--><img src="{{ asset('images/backoffice/pixeladmin-text-dark.png') }}" alt="home" class="light-logo" />
             </span>
            </a>
        </div>
